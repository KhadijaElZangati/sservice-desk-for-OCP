...
<head>
    <title> profile </title>
    <meta charset="utf-8">
    <link rel="stylesheet" href="profiletech.css">
    <style>
        .container {
            display: flex;
...
<div class="container bootstrap snippets bootdey">
    ...
    <div class='floating-div'>
      ...
      <h2><?php echo "administrateur: " . $administrateur; ?></h2>
  ...
  <div class='explaination'>
    <div class='paragraph'>
      <h1 style="color:black; text-align:left;">Votre tickets</h1>
      <?php
      $stmt= $dns->prepare('select * from reclamatiomuser where techid=:mat');
